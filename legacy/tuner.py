...
class tuner:
    ...
    def init_safe(self):
        ...
        if not os.path.exists(self.offline_sample):
            # Never truncate the offline_sample path here; Phase 1 resume and per-database outputs rely on preserving existing data.
